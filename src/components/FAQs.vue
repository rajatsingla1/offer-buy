<template>
  <section class="mt-16">
    <div class="text-center mb-8">
      <h2 class="text-3xl font-semibold text-ink">AlliedCredits FAQ</h2>
    </div>

    <div class="flex justify-center mb-10">
      <div
        class="inline-flex flex-wrap gap-1 rounded-full bg-primary-50/70 p-1.5 ring-1 ring-primary-100"
      >
        <button
        ...
        >
          ...
          <span
            ...
            class="absolute left-4 right-4 bottom-1 h-0.5 bg-primary rounded-full"
          ></span>
        </button>
      </div>
    </div>
    ...
    <div class="card p-6 sm:p-10">
      <ul class="divide-y divide-dashed divide-slate-200">
        <li
          v-for="(item, qIndex) in activeSection.items"
          :key="qIndex"
          class="py-5"
        >
          <button
          ...
          >
            ...
            <span
              class="shrink-0 text-2xl leading-none text-slate-500 transition-transform"
