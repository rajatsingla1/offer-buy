          ...
          <table class="table-fixed divide-y divide-primary-100">
            <thead class="sticky top-0 z-1 table-header">
              <tr>
                <th
                  scope="col"
                  class="min-w-[13rem] max-w-[13rem] w-[13rem] whitespace-nowrap px-4 py-2.5 text-left text-sm"
                >
                  Project Name /<br />UID
                </th>
                <th
            ...
            <tbody class="divide-y divide-primary-50 bg-white">
              ...
              <template v-else>
                ...
                >
                  <td
                    class="table-cell min-w-[13rem] max-w-[13rem] w-[13rem] overflow-hidden px-4 py-2.5"
                  >
                    <div
                      class="text-sm font-semibold text-ink line-clamp-2 whitespace-normal break-words"
