...
<template>
  <div class="mt-10 grid gap-6">
    <div class="card p-8">
      ...
      <p class="mt-2 text-slate-600">GET endpoint for listing AlliedCredits.</p>
      ...
      <div class="mt-3 rounded-xl bg-slate-50 p-4 font-mono text-sm">
        ...
        <p class="mt-1 break-all text-ink">
          <code class="rounded bg-white px-1.5 py-0.5">x-api-key-alliedexchange</code>
        </p>
      ...
      <button type="button"
        ...
        <svg class="h-5 w-5 shrink-0 transition-transform" :class="{ 'rotate-180': structureOpen }" fill="none"
          stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
        </svg>
      </button>
      <div v-show="structureOpen"
        ...
        <table class="min-w-full text-left text-sm">
          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <tr>
              ...
              <td class="table-cell text-slate-600">string</td>
              <td class="table-cell">Offer status (e.g. active)</td>
            </tr>
            <tr>
